...
describe('publish and unpublish stories', function() {
    ...
    it('should have all stories published by default when there only the dev environment', function() {
    ...
    it('when removing production environment, all stories should be published', function() {
        cy.visit('/project/bf/settings');
        cy.get('[data-cy=deployment-environments]')
            .children().contains('production').click();
        cy.get('[data-cy=save-changes]').click();
